...
| `docs`     | docs-only changes (`README.md`, `AGENTS.md`, comments)    |
...
git commit \
  ...
  -m "Co-Authored-By: <your current Codex model> <noreply@anthropic.com>"
```

Use whatever Codex model is actually running this session in the
...
- A `Co-Authored-By: <current Codex model> <noreply@anthropic.com>`
