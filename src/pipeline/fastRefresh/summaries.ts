...
export function jobRowToSummary(
  ...
  return {
    ...
    ingest: {
      ...
      captureQualityFlags: extractMarkdownMetadataList(row.markdown, "Capture quality flags"),
      markdownLineCount: markdownLineCount(row.markdown),
      markdownBulletCount: markdownBulletCount(row.markdown),
    },
